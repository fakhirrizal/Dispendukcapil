	...
	<div class="page-bg"></div>
		<div class="signin-form">
			...
			<form role="form" action="<?= site_url('login_process'); ?>" method='post'>
				...
				<div class="text-center small"><a href="#" data-toggle="modal" data-target="#myModal">Lupa Kata Sandi?</a></div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Form Lupa Kata Sandi</h4>
        </div>
        <div class="modal-body">
			<form role="form" class="form-horizontal" action="<?=base_url('atur_ulang_kata_sandi');?>" method="post"  enctype='multipart/form-data'>
				<div class="form-body">
